...
<div class="wrap">
    ...
    <?php if (isset($_GET['message']) && $_GET['message'] == 'shortcode_added_msg') { ?>
        <div class="updated notice">
            <p>
                <?php
                _e('Layout has been added successfully.', BLOGDESIGNERPRO_TEXTDOMAIN);
    ...
    if (isset($_GET['message']) && $_GET['message'] == 'shortcode_duplicate_msg') {
        ?>
        <div class="updated notice">
            <p><?php _e('Layout has been duplicated successfully.', BLOGDESIGNERPRO_TEXTDOMAIN); ?></p>
        </div>
        <?php
    }
    if (isset($bdp_errors)) {
                        ...
                        <ul class="bdp-settings">
                            ...
                            <li>
                                ...
                                <div class="bdp-right active_post_list">
                                    ...
                                    //query_posts('cache_results=false&no_found_rows=true&fields=ids&showposts=-1&post_status=publish&post_type=' . $post_type_hori);
                            ...
                            <li class="bdp_media_custom_size_tr display_image_tr">
                                ...
                                <div class="bdp-right">
                                    ...
                                    <div class="bdp_media_custom_size_tbl">
                                        <p> <span class="bdp_custom_media_size_title"><?php _e('Width', BLOGDESIGNERPRO_TEXTDOMAIN); ?><?php echo ' (px)'; ?> </span> <input type="number" min="1" name="media_custom_width" class="media_custom_width" id="media_custom_width" value="<?php echo (isset($bdp_settings['media_custom_width']) && $bdp_settings['media_custom_width'] != '' ) ? $bdp_settings['media_custom_width'] : ''; ?>" /></p>
                                        <p> <span class="bdp_custom_media_size_title"><?php _e('Height', BLOGDESIGNERPRO_TEXTDOMAIN); ?><?php echo ' (px)'; ?> </span> <input type="number" min="1" name="media_custom_height" class="media_custom_height" id="media_custom_height" value="<?php echo (isset($bdp_settings['media_custom_height']) && $bdp_settings['media_custom_height'] != '' ) ? $bdp_settings['media_custom_height'] : ''; ?>"/> </p>
                                    </div>
                                </div>
                            </li>
                        </ul>
