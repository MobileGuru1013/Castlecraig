            ...
            if (($bdp_settings['facebook_link'] == 1) || ($bdp_settings['twitter_link'] == 1) ||
                ...
                ?>">
                            ...
                            if (isset($bdp_settings['facebook_link_with_count']) && $bdp_settings['facebook_link_with_count'] == 1) {
                                if (isset($bdp_settings['social_style']) && $bdp_settings['social_style'] == 1) { ?>
                                    <div class="social-share">
                                        <a data-share="facebook" href="<?php echo get_the_permalink(); ?>" data-href="https://www.facebook.com/sharer/sharer.php" data-url="<?php echo get_the_permalink(); ?>" class="bdp-facebook-share social-share-default bdp-social-share"></a>
                                    </div>
                                <?php } else { ?>
                                    <div class="social-share">
                                        <a data-share="facebook" href="<?php echo get_the_permalink(); ?>" data-href="https://www.facebook.com/sharer/sharer.php" data-url="<?php echo get_the_permalink(); ?>" class="bdp-facebook-share facebook-share social-share-custom bdp-social-share">
                    ...
                    if ($bdp_settings['google_link'] == 1) {
                        ...
                        <div class="social-share">
                            <?php if (isset($bdp_settings['social_style']) && $bdp_settings['social_style'] == 1) { ?>
                                <a data-share="google" href="<?php echo get_the_permalink(); ?>" data-href="https://plus.google.com/share" data-url="<?php echo get_the_permalink();?>" class="bdp-google-share social-share-default bdp-social-share"></a>

                            <?php } else { ?>
                                <a data-share="google" href="<?php echo get_the_permalink(); ?>" data-href="https://plus.google.com/share" data-url="<?php echo get_the_permalink();?>" class="bdp-google-share social-share-custom bdp-social-share">
                    ...
                    if ($bdp_settings['twitter_link'] == 1) {
                        ...
                        if (isset($bdp_settings['social_style']) && $bdp_settings['social_style'] == 1) {
                            ?>
                             <a data-share="twitter" href="<?php echo get_the_permalink(); ?>" data-href="https://twitter.com/share" data-text="<?php echo get_the_title(); ?>" data-url="<?php echo get_the_permalink(); ?>" class="bdp-twitter-share social-share-default bdp-social-share"></a>
                        <?php } else { ?>
                            <a data-share="twitter" href="<?php echo get_the_permalink(); ?>" data-href="https://twitter.com/share" data-text="<?php echo get_the_title(); ?>" data-url="<?php echo get_the_permalink(); ?>" class="bdp-twitter-share social-share-custom bdp-social-share">
                    ...
                    if ($bdp_settings['linkedin_link'] == 1) {
                        if (isset($bdp_settings['linkedin_link_with_count']) && $bdp_settings['linkedin_link_with_count'] == 1) {
                            ...
                            <div class="social-share">
                                <?php if (isset($bdp_settings['social_style']) && $bdp_settings['social_style'] == 1) { ?>
                                    <a data-share="linkedin" href="<?php echo get_the_permalink(); ?>" data-href="https://www.linkedin.com/shareArticle" data-url="<?php echo get_the_permalink(); ?>" class="bdp-linkedin-share social-share-default bdp-social-share"></a>
                                <?php } else { ?>
                                    <a data-share="linkedin" href="<?php echo get_the_permalink(); ?>" data-href="https://www.linkedin.com/shareArticle" data-url="<?php echo get_the_permalink(); ?>" class="bdp-linkedin-share social-share-custom bdp-social-share">
                        ...
                        <?php } else {
                            ...
                            <div class="social-share">
                                ...
                                if (isset($bdp_settings['social_style']) && $bdp_settings['social_style'] == 1) {
                                    ...
                                    ?>
                                    <a data-share="linkedin" href="<?php echo get_the_permalink(); ?>" data-href="https://www.linkedin.com/shareArticle" data-url="<?php echo get_the_permalink(); ?>" class="bdp-linkedin-share social-share-default bdp-social-share">
                                    </a>
                                    <?php
                                } else {
                                    if (isset($bdp_settings['social_count_position']) && $bdp_settings['social_count_position'] == 'top') {
                    ...
                    if ($bdp_settings['pinterest_link'] == 1) {
                        ...
                        if (isset($bdp_settings['pinterest_link_with_count']) && $bdp_settings['pinterest_link_with_count'] == 1) {
                            ...
                            <div class="social-share">
                                <?php if (isset($bdp_settings['social_style']) && $bdp_settings['social_style'] == 1) { ?>
                                    <a data-share="pinterest" href="<?php echo get_the_permalink(); ?>" data-href="https://pinterest.com/pin/create/button/" data-url="<?php echo get_the_permalink(); ?>" data-mdia="<?php echo $pinterestimage[0]; ?>" data-description="<?php echo get_the_title(); ?>" class="bdp-pinterest-share social-share-default bdp-social-share">
                                    </a>
                                <?php } else { ?>
                                    <a data-share="pinterest" href="<?php echo get_the_permalink(); ?>" data-href="https://pinterest.com/pin/create/button/" data-url="<?php echo get_the_permalink(); ?>" data-mdia="<?php echo $pinterestimage[0]; ?>" data-description="<?php echo get_the_title(); ?>" class="bdp-pinterest-share social-share-custom bdp-social-share">
                        ...
                        <?php } else {
                            ...
                            <div class="social-share">
                                ...
                                if (isset($bdp_settings['social_style']) && $bdp_settings['social_style'] == 1) {
                                    ...
                                    ?>
                                    <a data-share="pinterest" href="<?php echo get_the_permalink(); ?>" data-href="https://pinterest.com/pin/create/button/" data-url="<?php echo get_the_permalink(); ?>" data-mdia="<?php echo $pinterestimage[0]; ?>" data-description="<?php echo get_the_title(); ?>" class="bdp-pinterest-share social-share-default bdp-social-share"></a>
                                    <?php
                                } else {
                                    if (isset($bdp_settings['social_count_position']) && $bdp_settings['social_count_position'] == 'top') {
                                        ?>
                    ...
                    if (isset($bdp_settings['skype_link']) && $bdp_settings['skype_link'] == 1) {
                        echo '<div class="social-share">';
                        if (isset($bdp_settings['social_style']) && $bdp_settings['social_style'] == 1) { ?>
                            <a data-share="skype" href="<?php echo get_the_permalink(); ?>" data-href="https://web.skype.com/share" data-url="<?php echo get_the_permalink(); ?>" data-text="<?php echo get_the_title(); ?>" class="bdp-skype-share social-share-default bdp-social-share"></a>
                        <?php } else { ?>
                            <a data-share="skype" href="<?php echo get_the_permalink(); ?>" data-href="https://web.skype.com/share" data-url="<?php echo get_the_permalink(); ?>" data-text="<?php echo get_the_title(); ?>" class="bdp-telegram-share social-share-custom bdp-social-share">
                    ...
                    if (isset($bdp_settings['telegram_link']) && $bdp_settings['telegram_link'] == 1) {
                        ...
                        if (isset($bdp_settings['social_style']) && $bdp_settings['social_style'] == 1) {
                            ?>
                            <a data-share="telegram" href="<?php echo get_the_permalink(); ?>" data-href="https://telegram.me/share/url" data-url="<?php echo urldecode(get_the_permalink()); ?>" data-text="<?php echo get_the_title(); ?>" class="bdp-telegram-share social-share-default bdp-social-share"></a>
                        <?php } else { ?>
                            <a data-share="telegram" href="<?php echo get_the_permalink(); ?>" data-href="https://telegram.me/share/url" data-url="<?php echo urldecode(get_the_permalink()); ?>" data-text="<?php echo get_the_title(); ?>" class="bdp-telegram-share social-share-custom bdp-social-share">
                    ...
                    if (isset($bdp_settings['pocket_link']) && $bdp_settings['pocket_link'] == 1) {
                        ...
                        if (isset($bdp_settings['social_style']) && $bdp_settings['social_style'] == 1) {
                            ?>
                            <a data-share="pocket" href="<?php echo get_the_permalink(); ?>" data-href="https://getpocket.com/save" data-url="<?php echo get_the_permalink(); ?>" data-title="<?php echo get_the_title(); ?>" class="bdp-pocket-share social-share-default bdp-social-share"></a>
                        <?php } else { ?>
                            <a data-share="pocket" href="<?php echo get_the_permalink(); ?>" data-href="https://getpocket.com/save" data-url="<?php echo get_the_permalink(); ?>" data-title="<?php echo get_the_title(); ?>" class="bdp-pocket-share social-share-custom bdp-social-share">
                    ...
                    if (isset($bdp_settings['reddit_link']) && $bdp_settings['reddit_link'] == 1) {
                        ...
                        if (isset($bdp_settings['social_style']) && $bdp_settings['social_style'] == 1) {
                            ?>
                            <a data-share="reddit" href="<?php echo get_the_permalink(); ?>" data-href="http://www.reddit.com/submit" data-url="<?php echo get_the_permalink(); ?>" data-title="<?php echo get_the_title(); ?>" class="bdp-reddit-share social-share-default bdp-social-share"></a>
                        <?php } else { ?>
                            <a data-share="reddit" href="<?php echo get_the_permalink(); ?>" data-href="http://www.reddit.com/submit" data-url="<?php echo get_the_permalink(); ?>" data-title="<?php echo get_the_title(); ?>" class="bdp-reddit-share social-share-custom bdp-social-share">
                    ...
                    if (isset($bdp_settings['digg_link']) && $bdp_settings['digg_link'] == 1) {
                        ...
                        if (isset($bdp_settings['social_style']) && $bdp_settings['social_style'] == 1) {
                            ?>
                            <a data-share="digg" href="<?php echo get_the_permalink(); ?>" data-href="http://digg.com/submit" data-url="<?php echo get_the_permalink(); ?>" data-title="<?php echo get_the_title(); ?>" class="bdp-digg-share social-share-default bdp-social-share"></a>
                        <?php } else { ?>
                            <a data-share="digg" href="<?php echo get_the_permalink(); ?>" data-href="http://digg.com/submit" data-url="<?php echo get_the_permalink(); ?>" data-title="<?php echo get_the_title(); ?>" class="bdp-digg-share social-share-custom bdp-social-share">
                    ...
                    if (isset($bdp_settings['tumblr_link']) && $bdp_settings['tumblr_link'] == 1) {
                        ...
                        if (isset($bdp_settings['social_style']) && $bdp_settings['social_style'] == 1) {
                            ?>
                            <a data-share="tumblr" href="<?php echo get_the_permalink(); ?>" data-href="http://tumblr.com/widgets/share/tool" data-url="<?php echo get_the_permalink(); ?>" data-title="<?php echo get_the_title(); ?>" class="bdp-tumblr-share social-share-default bdp-social-share"></a>
                        <?php } else { ?>
                            <a data-share="tumblr" href="<?php echo get_the_permalink(); ?>" data-href="http://tumblr.com/widgets/share/tool" data-url="<?php echo get_the_permalink(); ?>" data-title="<?php echo get_the_title(); ?>" class="bdp-tumblr-share social-share-custom bdp-social-share">
                    ...
                    if (isset($bdp_settings['wordpress_link']) && $bdp_settings['wordpress_link'] == 1) {
                        ...
                        if (isset($bdp_settings['social_style']) && $bdp_settings['social_style'] == 1) {
                            ?>
                            <a data-share="wordpress" href="<?php echo get_the_permalink(); ?>" data-href="http://wordpress.com/press-this.php" data-url="<?php echo get_the_permalink(); ?>" data-title="<?php echo get_the_title(); ?>" data-image="<?php echo get_the_post_thumbnail_url(); ?>" class="bdp-wordpress-share social-share-default bdp-social-share"></a>
                        <?php } else { ?>
                            <a data-share="wordpress" href="<?php echo get_the_permalink(); ?>" data-href="http://wordpress.com/press-this.php" data-url="<?php echo get_the_permalink(); ?>" data-title="<?php echo get_the_title(); ?>" data-image="<?php echo get_the_post_thumbnail_url(); ?>" class="bdp-wordpress-share social-share-custom bdp-social-share">
...
if (!function_exists('bdp_layout_view_portion')) {
    ...
    function bdp_layout_view_portion($layout_id, $bdp_settings) {
        ...
        $template_wrapper = '<div class="bdp_wrapper '.$bdp_theme.'_cover layout_id_'. $layout_id .'">';
