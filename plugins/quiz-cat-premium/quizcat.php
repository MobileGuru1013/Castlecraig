...
//[DEL_FROM_FREE]
add_action( 'admin_init', 'fca_qc_deactivate_free' );
function fca_qc_deactivate_free() {
	deactivate_plugins( 'quiz-cat/quizcat.php' );
}
//[END_DEL_FROM_FREE]
...
if ( !defined ('FCA_QC_PLUGIN_DIR') ) {
	...
	define( 'FCA_QC_PLUGIN_VER', '1.6.2' );
	...
	define( 'FCA_QC_PLUGIN_PACKAGE', 'Personal' ); //DONT CHANGE THIS, IT WONT ADD FEATURES, ONLY BREAKS UPDATER AND LICENSE
