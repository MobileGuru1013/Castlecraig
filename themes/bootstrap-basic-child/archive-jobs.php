					...
					<main id="main" class="site-main" role="main">
						...
						<header class="page-header">
							<h1 class="page-title">
								...
								elseif (is_day()) :
									printf(__('Posts from %s', 'bootstrap-basic'), '<span>' . get_the_date() . '</span>');

								elseif (is_month()) :
									printf(__('Posts from %s', 'bootstrap-basic'), '<span>' . get_the_date('F Y') . '</span>');

								elseif (is_year()) :
									printf(__('Posts from %s', 'bootstrap-basic'), '<span>' . get_the_date('Y') . '</span>');
								...
								elseif (is_tax('post_format', 'post-format-link')) :
									...
									_e('Job Positions', 'bootstrap-basic-child');
