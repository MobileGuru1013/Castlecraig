...
if (!class_exists('BootstrapCCMyWalkerNavMenu')) {
	class BootstrapCCMyWalkerNavMenu extends Walker_Nav_Menu
	{
		...
		public function start_lvl(&$output, $depth = 0, $args = array()) 
		{
			...
			$output .= "\n$indent<ul class=\"sub-menu dropdown-menu\"><a href=\"#\" class=\"mobilebackLink\">Back</a><h3 class=\"mobileparentTitle\"></h3>\n";
		}
